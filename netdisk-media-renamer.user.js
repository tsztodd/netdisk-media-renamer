...
(function (vue) {
  ...
  const _sfc_main$7 = vue.defineComponent({
    ...
    setup() {
      ...
      const canApply = vue.computed(() => {
        void refresh.value;
        return !!(providerRef2 == null ? void 0 : providerRef2.value.shouldContinue) && !isDisabled.value;
      });
      const onResetClick = () => {
  ...
  const _withScopeId$5 = (n) => (vue.pushScopeId("data-v-ef775fbb"), n = n(), vue.popScopeId(), n);
  const _hoisted_1$7 = {
    key: 0,
  ...
  const RenameControl = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$7], ["__scopeId", "data-v-ef775fbb"]]);
  /**!
   * Sortable 1.15.3
