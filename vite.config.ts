...
// 自动更新地址：由仓库地址推导出 main 分支上 user.js 的 raw 链接
const userscriptUpdateURL = `${packageJson.repository.replace(
  "github.com",
  "raw.githubusercontent.com"
)}/main/${packageJson.name}.user.js`;
    ...
    config.plugins?.push(
      ...
      monkey({
        ...
        userscript: {
          ...
          connect: ["api.themoviedb.org", "image.tmdb.org", "raw.githubusercontent.com"],
          match: urlSchemes,
          ...
          // 自动更新：油猴定期拉取本仓库 main 分支上的 user.js，比对 @version
